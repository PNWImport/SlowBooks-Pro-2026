...
const BenefitsPage = {
    ...
    plansTable(plans) {
        ...
        let html = `<div class="table-container"><table>
            <thead><tr>
                <th scope="col">Plan</th><th scope="col">Kind</th><th scope="col">Carrier</th><th scope="col">MEC</th><th scope="col">Funding</th>
                <th scope="col" class="amount">EE / mo</th><th scope="col" class="amount">ER / mo</th><th scope="col">Status</th>
            </tr></thead><tbody>`;
    ...
    async loadEnrollments() {
        ...
        let html = `<div class="table-container"><table>
            <thead><tr>
                <th scope="col">Employee</th><th scope="col">Plan</th><th scope="col">Kind</th><th scope="col">Coverage</th>
                <th scope="col">Status</th><th scope="col">Dependents</th><th scope="col">Actions</th>
            </tr></thead><tbody>`;
        for (const e of rows) {
    ...
    async loadAca() {
        ...
        let html = `<div class="table-container"><table>
            <thead><tr>
                <th scope="col">Employee</th><th scope="col">SSN</th>
                ${MONTHS.map(m => `<th scope="col" style="text-align:center;">${m}</th>`).join('')}
                <th scope="col">All 12</th><th scope="col">Plans</th><th scope="col">Part III</th>
            </tr></thead><tbody>`;
