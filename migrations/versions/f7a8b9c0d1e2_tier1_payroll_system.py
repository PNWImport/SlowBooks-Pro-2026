...
def upgrade() -> None:
    ...
    op.add_column(
        "employees",
        sa.Column("multiple_jobs", sa.Boolean(), server_default="false", nullable=True),
    )
    op.add_column(
        "employees",
        sa.Column(
            "dependents_amount", sa.Numeric(12, 2), server_default="0", nullable=True
        ),
    )
    op.add_column(
        "employees",
        sa.Column(
            "other_income_annual", sa.Numeric(12, 2), server_default="0", nullable=True
        ),
    )
    op.add_column(
        "employees",
        sa.Column(
            "deductions_annual", sa.Numeric(12, 2), server_default="0", nullable=True
        ),
    )
    op.add_column(
        "employees",
        sa.Column(
            "extra_withholding", sa.Numeric(12, 2), server_default="0", nullable=True
        ),
    )
    ...
    op.add_column(
        "pay_runs",
        sa.Column(
            "run_type", enum_col("payruntype"), server_default="REGULAR", nullable=True
        ),
    )
    op.add_column(
        "pay_runs",
        sa.Column(
            "total_employer_taxes", sa.Numeric(12, 2), server_default="0", nullable=True
        ),
    )
    ...
    for col in ("regular_hours", "overtime_hours", "doubletime_hours"):
        op.add_column(
            "pay_stubs",
            sa.Column(col, sa.Numeric(10, 2), server_default="0", nullable=True),
        )
    for col in (
        "state_other_employee",
        "pretax_deductions",
        "posttax_deductions",
        "employer_ss_tax",
        ...
        op.add_column(
            "pay_stubs",
            sa.Column(col, sa.Numeric(12, 2), server_default="0", nullable=True),
        )
    ...
    op.add_column(
        "vendors",
        sa.Column(
            "is_1099_eligible", sa.Boolean(), server_default="false", nullable=True
        ),
    )
    op.add_column(
        "vendors",
        sa.Column("w9_on_file", sa.Boolean(), server_default="false", nullable=True),
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "pay_run_id", sa.Integer(), sa.ForeignKey("pay_runs.id"), nullable=True
        ),
        sa.Column(
    ...
    op.create_index(
        op.f("ix_time_entries_employee_id"), "time_entries", ["employee_id"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "accrual_method", enum_col("accrualmethod"), server_default="PER_PAY_PERIOD"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "policy_id", sa.Integer(), sa.ForeignKey("pto_policies.id"), nullable=False
        ),
    ...
    op.create_index(
        op.f("ix_pto_accruals_employee_id"), "pto_accruals", ["employee_id"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "approver_id", sa.Integer(), sa.ForeignKey("employees.id"), nullable=True
        ),
        sa.Column("notes", sa.Text(), nullable=True),
        sa.Column(
            "created_at", sa.DateTime(timezone=True), server_default=sa.func.now()
    ...
    op.create_index(
        op.f("ix_pto_requests_employee_id"), "pto_requests", ["employee_id"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "account_kind", enum_col("bankaccountkind"), server_default="CHECKING"
        ),
        ...
        sa.Column(
            "prenote_status", enum_col("prenotestatus"), server_default="NOT_SENT"
        ),
    ...
    op.create_index(
        op.f("ix_employee_bank_accounts_id"), "employee_bank_accounts", ["id"]
    )
    op.create_index(
        op.f("ix_employee_bank_accounts_employee_id"),
        "employee_bank_accounts",
        ["employee_id"],
    )
...
def downgrade() -> None:
    ...
    op.add_column(
        "employees",
        sa.Column("allowances", sa.Integer(), server_default="0", nullable=True),
    )
    for col in (
        "wc_class_code",
        "work_state",
