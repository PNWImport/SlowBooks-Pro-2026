...
def upgrade() -> None:
    ...
    op.add_column(
        "items",
        sa.Column(
            "track_inventory", sa.Boolean(), server_default="false", nullable=False
        ),
    )
    op.add_column(
        "items",
        sa.Column(
            "quantity_on_hand", sa.Numeric(14, 4), server_default="0", nullable=False
        ),
    )
    op.add_column(
        "items",
        sa.Column(
            "reorder_point", sa.Numeric(14, 4), server_default="0", nullable=False
        ),
    )
    op.add_column(
        "items",
