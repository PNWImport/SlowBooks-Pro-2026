...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("DRAFT", "SENT", "PARTIAL", "PAID", "VOID", name="invoicestatus"),
            nullable=True,
        ),
        sa.Column("date", sa.Date(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column(
            "item_type",
            sa.Enum("PRODUCT", "SERVICE", "MATERIAL", "LABOR", name="itemtype"),
            nullable=False,
        ),
        sa.Column("description", sa.Text(), nullable=True),
    ...
    op.create_index(
        op.f("ix_transaction_lines_id"), "transaction_lines", ["id"], unique=False
    )
    op.create_table(
        "bank_transactions",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_bank_transactions_id"), "bank_transactions", ["id"], unique=False
    )
    op.create_table(
        "estimates",
        sa.Column("id", sa.Integer(), nullable=False),
        ...
        sa.Column(
            "status",
            sa.Enum(
                "PENDING", "ACCEPTED", "REJECTED", "CONVERTED", name="estimatestatus"
            ),
            nullable=True,
        ),
        sa.Column("date", sa.Date(), nullable=False),
    ...
    op.create_index(
        op.f("ix_payment_allocations_id"), "payment_allocations", ["id"], unique=False
    )
    op.create_table(
        "reconciliations",
        sa.Column("id", sa.Integer(), nullable=False),
        ...
        sa.Column(
            "statement_balance", sa.Numeric(precision=12, scale=2), nullable=False
        ),
        sa.Column(
            "status",
            sa.Enum("IN_PROGRESS", "COMPLETED", name="reconciliationstatus"),
            nullable=True,
        ),
        sa.Column(
            "created_at",
    ...
    op.create_index(
        op.f("ix_reconciliations_id"), "reconciliations", ["id"], unique=False
    )
    op.create_table(
        "estimate_lines",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_estimate_lines_id"), "estimate_lines", ["id"], unique=False
    )
