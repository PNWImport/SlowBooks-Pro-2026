...
def upgrade() -> None:
    ...
    op.add_column(
        "vendors",
        sa.Column(
            "is_1099_vendor", sa.Boolean(), server_default="false", nullable=True
        ),
    )
    op.add_column(
        "vendors", sa.Column("vendor_1099_type", sa.String(10), nullable=True)
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "vendor_id", sa.Integer(), sa.ForeignKey("vendors.id"), nullable=True
        ),
